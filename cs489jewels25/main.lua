...
function drawGameOverState()
    ...
    love.graphics.printf("Press Enter to Play or Escape to exit",
        0,90, gameWidth,"center")
    love.graphics.printf("Score: "..tostring(board.stats.totalScore), titleFont,0,120,gameWidth,"center")
    love.graphics.printf("level placement: "..tostring(stats.level),0,150,gameWidth,"center")
end
